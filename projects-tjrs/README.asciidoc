== projects-tjrs
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The projects-tjrs addon enables blah blah...)
...
----
<dependency>
   <groupId>br.jus.tjrs.forge</groupId>
   <artifactId>projects-tjrs</artifactId>
